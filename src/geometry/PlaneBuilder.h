...
namespace Geometry
{
	...
	*/
	struct PlaneSettings
	{
		...
		pmp::Scalar Width{ 1.0 }; //! dimension in the x-direction
		pmp::Scalar Depth{ 1.0 }; //! dimension in the y-direction
